...
def RMLogo(publisher):
    ...
    setDesiredOrientation(publisher, 30, 52)

    # rotate(publisher, 20, 90, True)
    move(publisher, 2.0, 5.0, True)
    go_to_goal(publisher, 3, 5)
    go_to_goal(publisher, 5.5, 5.5)
    # for i in range(5):
    #     move(publisher, 2.0, 1.0, True)
    #     rotate(publisher, 20, 90, False)
    #     move(publisher, 2.0, 9.0, True)
